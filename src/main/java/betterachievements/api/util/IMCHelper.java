 ...
 * tab in {@link betterachievements.gui.GuiBetterAchievements} of the given
 * {@link AchievementPage} Can be used as replacement for
 * {@link betterachievements.api.components.page.ICustomIcon} NOTE: IMC will
 * most likely register before the {@link ICustomIcon#getPageIcon()} will ever
 * be called In short this will override what ever is set there, so use only one
 * of both
 */
