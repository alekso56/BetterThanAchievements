...
public interface ICustomArrows {
	 ...
	 * {@link betterachievements.api.util.ColourHelper#RGB(String)} to use
	 * #RRGGBB format to integer
	 *
	 ...
	 * yet Use {@link betterachievements.api.util.ColourHelper#RGB(String)} to
